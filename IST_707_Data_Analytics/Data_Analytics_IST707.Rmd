...
Nominal_RB.WR$Receiving.Yards <- cut(Nominal_RB.WR$Receiving.Yards, breaks = c(-Inf,-1,50,100,150,200,250,300,Inf),
...
Nominal_RB.WR$Longest.Rushing.Run <- cut(Nominal_RB.WR$Longest.Rushing.Run, breaks = c(-Inf,-1,20,40,60,80,Inf),
...
par(mar=c(1,1,1,1))
plot(nb_Pred, ylab = "Density", main = "QB Naive Bayes Plot")
}
...
for (k in 1:kfolds){
  ...
  #Setting margins for Naive Bayes Plot - QB Pred
  par(mar=c(1,1,1,1))
  #Plotting Naive Bayes
  plot(nb_Pred1, ylab = "Density", main = "Naive Bayes Plot-RB/WR Pred", col="blue")
}
